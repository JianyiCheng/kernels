...
void gemm(int a_0, int a_1, int a_2, int a_3, int a_4, int a_5, int a_6,
          ...
          int b_5, int b_6, int b_7, int b_8, int tmp_0, int tmp_1, int tmp_2,
          int tmp_3, int tmp_4, int tmp_5, int tmp_6, int tmp_7, int tmp_8,
          int alpha, int beta, int c_0[1], int c_1[1], int c_2[1], int c_3[1],
          int c_4[1], int c_5[1], int c_6[1], int c_7[1], int c_8[1]) {
